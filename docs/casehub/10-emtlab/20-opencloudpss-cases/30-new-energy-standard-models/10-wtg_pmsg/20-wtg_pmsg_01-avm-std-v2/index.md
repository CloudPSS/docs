---
title: 直驱风机 01 型-平均模型-标准模型-v2
description: 直驱风机 01 型-平均模型-标准模型-v2
...
以下为SCR=2时，**直驱风机01型-平均模型-标准模型-v2**在三相20%Un跌落、三相130%Un抬升工况下的仿真结果。其中，蓝色曲线Vrms_HV为并网点电压、黄色曲线P_HV为并网点处有功功率、绿色曲线Q_HV为并网点处无功功率。  
...
点击打开模型地址：[**直驱风机01型-平均模型-标准模型-v2**](cloudpss:/model/open-cloudpss/WTG_PMSG_01-avm-std-v2b2)  
