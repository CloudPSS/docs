...
在拓扑如图所示的[CSEE-RAS](../../../10-opencloudpss-cases/20-csee-standard-cases/10-csee_ras_aperiodic-v1/index.md)（新型电力系统标准算例-功角失稳）标准算例中，将风机、光伏替换为**跟网/构网型并网变流器-平均模型**，并在B03区新增储能和静止无功发生器，均采用**跟网/构网型并网变流器-平均模型**。 
