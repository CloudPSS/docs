...
**跟网型储能变流器-平均模型**由平均化电气拓扑、锁相环、功率外环、电流内环、调制环节等模块构成，还附加了标幺化、倍乘等值、量测与输出、多短路比测试实现，直流侧为储能电池，后续可拓展斩波控制、穿越控制、脱网控制等模块。本案例由清华大学沈沉教授团队（赖启平、沈怡、李陶、曹宇祺、李姝嫚、杨明皓博士参与）构建，模型整体架构如下图所示。  
