...
拓扑编辑区包括上方的工具栏、中间的图纸、左侧的垂直滚动条以及下方的水平滚动条。
...
+ 右侧的图纸缩放功能按钮组：通过点击放大/缩小按钮，或拖动滑块，调整当前图纸的视图比例；也可点击**视图比例**按钮，在下拉菜单中选择图纸的比例。也可以按住`ctrl`键，利用鼠标滚轮来缩放视图。同时也可以用按住`ctrl + 鼠标右键`，拖动鼠标来平移视图。
