...
拓扑编辑区包括**上方的工具栏**、**中间的图纸**、左侧的**垂直滚动条**以及下方的**水平滚动条**。

![拓扑编辑区的布局](./9.png)

上方的工具栏提供如下按钮:

+ 左右两侧的缩进/展开按钮：用于隐藏或显示资源栏和属性栏；
+ 图纸 tab 按钮：在图纸栏选中图纸后，会在拓扑编辑区的工具栏内显示该图纸的 tab 按钮，帮助用户快速切换图纸，点击 **X** 可关闭该图纸；
+ 右侧的图纸缩放功能按钮组：通过点击放大/缩小按钮，或拖动滑块，调整当前图纸的视图比例；也可点击**视图比例**按钮，在下拉菜单中选择图纸的比例。

也可按住`ctrl`键，利用鼠标滚轮来缩放视图。同时也可以用按住`ctrl + 鼠标右键`，拖动鼠标来平移视图。

![图纸视图比例调整](./8.png)

左侧的垂直滚动条: 长按垂直滚动条向上或向下移动图纸查看其余部分。也可使用鼠标旋转轮完成图纸的向上或向下移动。

下方的水平滚动条: 长按水平滚动条向左或向右移动图纸查看其余部分。也可使用 `Shift + 鼠标旋转轮` 完成图纸的向左或向右移动。
...
+ 选中拓扑编辑区中的现有元件，通过修改**格式卡**中的**X**和**Y**位置坐标，可精确控制元件位置。具体方法参见 格式卡 参数页 引用。

拓扑编辑过程中元件的缩放方法主要有 2 种。
+ 选中拓扑编辑区中的现有元件，按住元件图标四角的**圆形图标**拖拽，可对元件进行等比例缩放。
+ 选中拓扑编辑区中的现有元件，通过修改**格式卡**中的**宽度**和**高度**，可精确控制元件图标大小。具体方法参见 格式卡 参数页 引用。

拓扑编辑过程中元件的旋转、翻转方法主要有 3 种。
+ 选中拓扑编辑区中的现有元件，按住元件图标左上方的**菱形图标**拖拽，可对元件进行任意角度旋转。
+ 选中拓扑编辑区中的现有元件，右键弹出菜单，选择顺/逆时针旋转，可对元件进行 90° 旋转。
+ 选中拓扑编辑区中的现有元件，通过修改**格式卡**中的**排列配置**，可对元件进行 90° 旋转和镜像翻转。具体方法参见 格式卡 参数页 引用。
...
选中多个元素后，可选择创建为子模块，可将这部分拓扑另存为一个单独的模型项目。该功能详细使用说明参见 [模块封装](../../../../basic/moduleEncapsulation/index.md)。
...
获取元件的最新版本。该功能详细使用说明参见 XXX。

### 元件表

弹出元件表对话框。该功能详细使用说明参见 [元件表](../../../../basic/componentTable/index.md)。
