...
:::info
若一个元件中同时存在拓扑实现和 Octave 实现，将以 Octave 实现优先，拓扑实现将被忽略。
:::
...
- 新建 Octave 元件  
    ...
    ![新建 Octave 元件](./case1-creatr-new-octave-comp.png "新建 Octave 元件")
...
- 元件名称与权限设置
    ...
    ![元件名称与权限设置](./case1-set-name-and-permission.png "元件名称与权限设置")
...
- 新建固定频率触发的 Octave 元件  
    ...
    ![新建固定频率触发的 Octave 元件](./case2-creatr-new-octave-comp.png "新建固定频率触发的 Octave 元件")
...
- 元件名称与权限设置
    ...
    ![元件名称与权限设置](./case2-set-name-and-permission.png "元件名称与权限设置")
...
- 新建外部触发的 Octave 元件  
    ...
    ![新建外部触发的 Octave 元件](./case3-creatr-new-octave-comp.png "新建外部触发的 Octave 元件")
...
- 元件名称与权限设置
    ...
    ![元件名称与权限设置](./case3-set-name-and-permission.png "元件名称与权限设置")
