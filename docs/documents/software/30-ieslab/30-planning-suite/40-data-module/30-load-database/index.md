...
点击**新建一行**按钮，会自动创建一个新的负荷。

在页面上方的**搜索输入框**，在输入框中输入负荷名称等任意关键字，即可进行模糊搜索或筛选（关键字不区分大小写）。

如果需要删除负荷，点击列表右侧的**删除**按钮，即可进行单个删除。
点击负荷信息左侧的选中框，点击“**删除**”按钮，可将选中的负荷信息删除

![新建与删除](./delete.png "新建与删除")

### 负荷参数编辑

点击负荷所在行的**编辑**按钮，即可编辑负荷参数信息。
...
氢负荷和氨负荷模型提供**分月详细负荷**和**自定义负荷**两种模型。
...
:    若您需要非常准确的建筑物能耗仿真，建议使用专业的建筑能耗商业软件。
