...
| 最小制氢容量配置 | `MiniHydrogenCapacity` | Nm<sup>3</sup>/h | 设备的最小制氢容量配置 | 实数 | 仅当**待选设备类型**选择数据管理模块输入的设备后生效。|
| 最大制氢容量配置 | `MaxHydrogenCapacity` | Nm<sup>3</sup>/h | 设备的最大制氢容量配置 | 实数 | 仅当**待选设备类型**选择数据管理模块输入的设备后生效。|
