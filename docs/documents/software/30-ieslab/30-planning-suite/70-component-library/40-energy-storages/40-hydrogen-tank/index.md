...
| 最小储氢容量配置 | `MiniHydrogenStorageTankCapacity` | Nm<sup>3</sup> | 设备的最小储氢容量配置 | 实数 | 仅当**待选设备类型**选择数据管理模块输入的设备后生效。|
| 最大储氢容量配置 | `MaxHydrogenStorageTankCapacity` | Nm<sup>3</sup> | 设备的最大储氢容量配置 | 实数 | 仅当**待选设备类型**选择数据管理模块输入的设备后生效。|
...
| 参数名 | 键值 (key)  | 单位 | 备注 | 类型 | 描述 |
| :--- | :--- | :--- | :--: | :--- | :--- |
| 初始蓄氢比例 | `initialHydrogenStorageTankSOC` |  | 初始蓄氢比例 | 实数 | 初始时刻蓄氢比例 = 初始时刻蓄氢量/蓄氢容量 |
| 最大蓄氢 SOC | `maxHydrogenStorageTankSOC` |  | 最大蓄氢 SOC | 实数 | 最大蓄氢 SOC = 最大蓄氢量/蓄氢容量 |
| 最小蓄氢 SOC | `minHydrogenStorageTankSOC` |  | 最小蓄氢 SOC | 实数 | 最下蓄氢 SOC = 最小蓄氢量/蓄氢容量，注意最小蓄氢 SOC 需小于最大蓄氢 SOC |
