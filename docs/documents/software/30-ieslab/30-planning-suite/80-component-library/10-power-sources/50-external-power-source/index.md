...
| 是否两部制电价 | `IsTwoPartPrice` |  | 是否两部制电价 | 选择 | 是否采用两部制电价，选“是”或“否”；不选两部制电价时按单一制电费计费 |
| 基本电价模型 | `BasicPriceModel` |  | 基本电价模型 | 选择 | '0'表示容量电价，'1'表示需量电价；选择需量电价模型时，需量电价为输入值 |
| 最大用电容量 | `MaxiumElectricSupply` | kW | 最大用电容量 | 实数 | 按容量电价计费时用于计算基本电费的最大下网功率 |
| 容量电价 | `CapacityPrice` | 元/kW·月 | 容量电价 | 实数 | 容量基础电价单价，仅当基本电价模型为容量电价时生效 |
| 需量电价 | `DemandPrice` | 元/kW·月 | 需量电价 | 实数 | 需量基础电价单价，仅当基本电价模型为需量电价时生效 |
...
| 最大上网率 | `MaxFeedinRatio` | % | 最大上网率 | 实数 | 新能源上网电量占总可用发电量的比例，绿电直连项目一般不得高于20%，仅当允许发电上网时生效 |
| 峰谷差率上限 | `RatePeakValley` | % | 峰谷差率上限 | 实数 | 峰谷差率=(最大下网功率-最小下网功率)/最大下网功率，用于约束下网功率的波动幅度 |
