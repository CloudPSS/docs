...
| 运行模式 | `OperType` |  | 选择 | 选择 | 提供制热、制冷和制冷制热三种运行模式 |
...
| 最小供热容量配置 | `MiniHeatCapacity` | kW | 最小供热容量配置 | 实数 | 仅当**待选设备类型**选择数据管理模块输入的设备后生效。|
| 最大供热容量配置 | `MaxHeatCapacity` | kW | 最大供热容量配置 | 实数 | 仅当**待选设备类型**选择数据管理模块输入的设备后生效。|
| 最小供冷容量配置 | `MiniCoolCapacity` | kW | 最小供冷容量配置 | 实数 | 仅当**待选设备类型**选择数据管理模块输入的设备后生效。|
| 最大供冷容量配置 | `MaxCoolCapacity` | kW | 最大供冷容量配置 | 实数 | 仅当**待选设备类型**选择数据管理模块输入的设备后生效。|
...
| 冷接口 | `coolPort` | 1×1 | 可以在引脚处输入相同的字符使得设备与其他电元件相连|
