...
:::note  
1.删除“优化参数”部分，；目前不支持是否选择优化设备。
2.删除常见问题中的以下部分（此部分属于储氢罐的常见问题），补充电解槽的常见问题。
能否设置储氢 SOC 上下限？
:   支持。
...
|-------------|------------------|--------------|----------------|----------------|
| 性能参数        | 电解池能耗/(kWh/Nm^3) | 4.2-4.8      | 4.4-5.0        | 3              |
|  ^   | 系统能耗/(kWh/Nm^3)  | 5.0-5.9      | 5. 2-5.9       | 3.7-3.9        |
...
Q = P\eta_{heat}
$$
 式中，$P、Q、V$分别表示电解槽的耗电功率（kW）、制热功率（kW）和产氢体积流率（Nm^3/h）；$\eta_{h2}、\eta_{heat}$分别表示电解槽的产氢系数（Nm^3/kWh）和产热系数（%）。
...
| 产氢系数 | `HydrogenGenCoe` | Nm^3/kWh | 额定产氢系数 | 实数 | 单位电量（kWh）的产氢量（Nm^3） |
...
| 最大氢气产量 | `MaxHydrogenGen` | Nm^3/h | 最大氢气产量 | 实数 | 最大氢气产量 |
