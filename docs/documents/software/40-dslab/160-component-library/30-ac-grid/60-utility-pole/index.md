...
| 额定频率 | `freq` | Hz  | 额定频率 | 实数 | 额定频率 |
| 斜坡启动时间(仅初始化用) | `RampingTime` | s  | 斜坡启动时间(仅初始化用) | 实数 | 斜坡启动时间(仅初始化用) |
| 母线电压相位 | `freq` | Deg  | 母线电压相位 | 实数 | 母线电压相位 |
| 母线电压幅值 | `freq` | p.u.  | 母线电压幅值 | 实数 | 母线电压幅值 |
| 母线电压基值 | `freq` | kV  | 母线电压基值 | 实数 | 母线电压基值 |
| 三相电压-Switch | `VabcSwitch` |  | 电源电压均方根值 | 开关 | 暂态仿真输出选择-三相电压 |
| 电压均方根值-Switch| `VrmsSwitch` |  | 电源电流均方根值 | 开关 | 暂态仿真输出选择-电压均方根值 |
