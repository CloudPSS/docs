...
该元件指直流传输线的设备设施，配网系统直流传输线路按结构可分为**架空线路和电缆线路**两大类别，在配网系统中主要起传输电能的作用。元件类型可选交流或直流。

**直流传输线的Π型等值模型：**

![直流传输线 =x200](./IES-GD-2Line-1.png)
$$
Z = ({r_{1} }^{*} + j{x_{1} }^{*})l
$$
$$
