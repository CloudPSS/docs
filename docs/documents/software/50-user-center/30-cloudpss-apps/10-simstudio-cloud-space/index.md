...
+ **CloudPSS公网主站（`www.cloudpss.net`）** 的用户，可参见 [注册与登录功能（公网主站）](../../10-register-and-login/10-cloudpss-public/index.md "注册与登录功能（公网主站）")。
+ **CloudPSS Mini、CloudPSS Pro** 等私有部署平台的用户，可参见 [登录与重置密码功能（私有部署）](../../10-register-and-login/20-cloudpss-private/index.md "登录与重置密码功能（私有部署）")。
