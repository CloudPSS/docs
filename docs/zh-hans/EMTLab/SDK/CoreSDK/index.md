...
EMTLab Core SDK提供了使用EMTLab仿真内核来自定义电磁暂态仿真元件的功能。EMTLab Core SDK采用C++代码编写，电磁暂态仿真原理详见[电磁暂态仿真原理](../../EMPT/fundamental/index.md)帮助文档，本文档主要说明使用EMTLab Core SDK编写自定义元件的方法。
...
- 构建前端元件  
  此部分详见[CloudPSS SDK 元件](../../EMPT/custom/SDK/index.md)帮助文档
