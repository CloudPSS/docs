...
- 我希望完成课程实验
:::success 
你只需要在`项目类型`处选择`简单项目`，按照[**快速入门**](/docs/zh-hans/EMTLab/guide/basics/index.md)中的3个算例构建提示，掌握CloudPSS SimStudio的基础功能，学习[**量测和输出系统**](/docs/zh-hans/EMTLab/EMPT/measure/index.md)，即可实现上述需求。
:::
...
- ...
:::success 
在掌握CloudPSS SimStudio的基础功能后，你需要进一步了解CloudPSS的[**参数和引脚体系**](../basic/parameterSystem/index.md)、[**元件表**](../basic/componentTable/index.md)、[**参数方案配置**](/docs/zh-hans/EMTLab/SimStudio/basic/parameterCalculate/index.md)功能。在`项目类型`处选择`普通项目`，即可使用CloudPSS完成这些研究。
:::
...
- ...
:::success 
你需要进一步掌握[**模块封装**](../basic/moduleEncapsulation/index.md)、[**模块调用**](../basic/callModule/index.md)、[**权限管理**](/docs/zh-hans/EMTLab/SimStudio/workbench/function/summary/index.md)等功能。在`项目类型`处选择`元件`，即可使用CloudPSS构建自定义元件。
:::
