...
date: 2022/1/8 11:14:00
updated: 2022/1/8 11:14:00

type: components
category: 3004
order: 500

classname: DTransformer
symbol: DTransformer
---
## 基本描述


> **该元件用以建模配电网两绕组变压器（单线图，中性点内置）。**
...
| Transformer Type |  | 双绕组变压器 | 选择 | 有A相、B相、C相、AB相、BC相、AC相和ABC相7种 |
