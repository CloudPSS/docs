...
如图所示，从功能上，数字孪生应用体系自底向上划分为`基础硬件平台`、`基础环境依赖`、`功能模块`、`数字孪生工坊`和`平台应用` 5 个部分：

- **在底层硬件支撑层，CloudPSS设计了专有计算设备，提供私有云和公有云部署等不同方案；**

- **基础环境依赖层包括CloudPSS数字孪生应用对操作系统、网络、数据库和静态服务的需求；**

- **功能模块层包含了CloudPSS原生模型库和原生计算内核，同时也包括了用户自定义或第三方内核；**

- **数字孪生工坊层提供了完整的XStudio工坊，为构建数字孪生应用提供了基础平台；**
