...
## 描述
IEEE 39节点标准系统，是美国新英格兰州的一个电力网络。该系统包括10台发电机，39个母线，12台变压器。
...
![模块内部图](IEEE39/I4.png "励磁调节器模块内部图")
...
+ 全部设备元件的端口必须与母线直接相连（或通过分线器与母线相连），但理想电流表等量测模块可以串入母线与元件端口之间。
...
依照上述参数和拓扑构建好39节点系统，使用从稳态方式启动运行仿真，点击`电磁暂态->开始`后选择神威节点，即可得到暂态结果。
