...
![端口定义](SubGraph/zt1.png)

子图端口的自定义界面如图所示。

![定义界面](SubGraph/zt2.png)
...
创建完毕后工作空间中将出现该子图的封装图标，双击该图标可打开子图。子图所处的页面为Sub，即新图标图层的名称。点击页面名称变边的“X”号可关闭该子图。

![打开子图](SubGraph/zt4.png)
