...
系统栏功能利用树状图形式来展现当前算例的系统嵌套结构，点击系统名称可实现快速导航并定位至该系统。当创建新的子系统时，该树形图将同步生成新的分支。删除某一子系统后，该树形图将删除该节点下的所有分支。创建及删除子系统的步骤详见[系统功能](System.html)。一个包含多个子系统的典型算例的系统栏如下图所示：
